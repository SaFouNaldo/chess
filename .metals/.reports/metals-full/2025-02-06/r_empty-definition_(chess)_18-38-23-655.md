...
/**
  ...
  */
  ...
  // Debug prints after getting actual cells
    ...
    // Update grid
    grid = grid.updated(fromRow, grid(fromRow).updated(fromCol, Cell(8 - fromRow, numberToChar(fromCol), Piece.Empty, PieceColor.White)))
